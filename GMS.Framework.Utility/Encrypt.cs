...
namespace GMS.Framework.Utility
{
    ...
    public class Encrypt
    {
        ...
        public static string Encode(string encryptString, string encryptKey = "pingpingliao")
        {
        ...
        public static string Decode(string decryptString, string decryptKey = "pingpingliao")
        {
            try
            {
